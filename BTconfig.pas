...
type
  ...
  public
    ...
    procedure Setup(BluetoothManager : TBluetoothManager; PairedDevices : TBluetoothDeviceList; Adapter: TBluetoothAdapter);
...
//메인 폼에서 Setup을 호출해서 블루투스 컴포넌트의 정보들을 넘겨준다.
procedure TBTMethod.Setup(BluetoothManager: TBluetoothManager;
  PairedDevices: TBluetoothDeviceList; Adapter: TBluetoothAdapter);
begin
  FBluetoothManager := BluetoothManager;
